...
/*!
  ...
  */
WFFR_API int wfFR_Init(void** pHandle, const char* pBasePath, int iFrameWid, int iFrameHig, int iFrameStep, enum FRMode eFrMode, int enableAntiSpoofing);
...
/*! Recognize face from video
  ...
  \param runDetectionOnly - Set 1 to run detection only, set 0 to run detection and recognition
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFRREC_API int wfFR_RecognizeFaces(void* handle, const unsigned char* pFrameData, int iFrameWid, int  iFrameHig, int iFrameStep, struct FRIDList* pResult, int* pStatus);
...
/*! Enroll face from video/image
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFR_API int wfFR_EnrollFace(void* handle, const unsigned char* pImageData, int iImageWid, int iImageHig, int iImageStep, unsigned long lRecordID, int iForce, struct FRIDList* pResult, int* pStatus);
...
/*! Recognize face saved image like jpeg/bmp/png
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFRREC_API int wfFR_RecognizeFacesFromSavedImage(void* handle, const char* pImageFilename, struct FRIDList* pResult, int* pStatus);
...
/*! Recognize face from Jpeg buffer
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFRREC_API int wfFR_RecognizeFacesFromJpegBuffer(void* handle, const char* pJpegBuffer, int iJpegBufferSize, struct FRIDList* pResult, int* spoofStatus);
...
/*! Detect and Recognize face from video in multi-thread. Detection is syncronous and recognition is async
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFRREC_API int wfFR_DetectRecognizeFacesMultiThread(void* handle, const unsigned char* pFrameData, int iFrameWid, int  iFrameHig, int iFrameStep, struct  FRIDList* pResult, int* pStatus);
...
/*! Enroll face from saved image like jpeg/bmp/png
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFR_API int wfFR_EnrollFaceFromSavedImage(void* handle,  const char* pImageFilename, unsigned long lRecordID, struct FRIDList* pResult, int* pStatus);
...
/*! Enroll face from Jpeg buffer
  ...
  \return FR_OK in case of success, or error code FR_ERROR_GENERAL otherwise
  */
WFFR_API int wfFR_EnrollFaceFromJpegBuffer(void* handle,  const char* pJpegBuffer, int iJpegBufferSize, unsigned long lRecordID, struct FRIDList* pResult, int* spoofStatus);
